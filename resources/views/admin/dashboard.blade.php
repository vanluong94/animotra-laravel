        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Mangas
                            </div>
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">{{ $mangas }}</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-auto">
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div
                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Tokens Resources</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    ...
                    <div class="mt-4 text-center small">
                        ...
                        <span class="mr-2">
                            <i class="fas fa-circle text-success"></i> Spent
                        </span>
                    </div>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div
                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">This month Best Selling</h6>
                </div>
                <!-- Card Body -->
                <div class="card-body">
                    <div class="chart-area">
